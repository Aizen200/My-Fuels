          ...
          <div className="bg-white rounded-3xl p-8 w-full max-w-3xl shadow-2xl relative animate-scale-up overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 flex flex-col justify-center">
                ...
                <span className="text-[10px] text-slate-500 mt-1">Updated Just now</span>
              </div>
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 flex flex-col justify-center">
                ...
                <span className="text-[10px] text-blue-600 font-medium mt-1 flex items-center gap-1">● GPS Locked</span>
              </div>
            </div>
            ...
            {trackingOrder.status === 'Out for Delivery' ? (
              ...
              <div className="w-full h-80 bg-slate-50 rounded-2xl border border-slate-200 mb-2 flex flex-col items-center justify-center p-6 text-center shadow-inner">
                <div className="w-16 h-16 rounded-full bg-user-100 flex items-center justify-center mb-4">
                  <HiOutlineTruck className="text-user-600" size={32} />
                </div>
                <h3 className="text-lg font-bold text-slate-900">Map Tracking Unavailable</h3>
                <p className="text-slate-500 text-sm mt-1 max-w-md">
                  Live GPS route tracking will automatically activate as soon as your order status changes to <span className="font-semibold text-user-600">Out for Delivery</span>.
                </p>
                <div className="mt-6 px-4 py-2 bg-white rounded-xl border border-slate-200 text-xs font-semibold text-slate-600 shadow-sm">
                  Current Status: <span className="text-user-600 uppercase">{trackingOrder.status}</span>
                </div>
              </div>
            )}
          </div>
