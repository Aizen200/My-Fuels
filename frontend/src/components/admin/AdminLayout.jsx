  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex-1 md:ml-64 flex flex-col min-w-0">
        <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-slate-200 px-6 py-4 flex items-center justify-between md:justify-end gap-4 relative">
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <Link to="/admin/profile" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
              ...
              <div className="w-9 h-9 rounded-full bg-admin-600 flex items-center justify-center shadow-md">
