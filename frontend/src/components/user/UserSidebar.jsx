...
import { HiOutlineViewGrid, HiOutlinePlusCircle, HiOutlineClock, HiOutlineUser, HiOutlineLogout, HiOutlineX } from 'react-icons/hi';
...
const UserSidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <>
      ...
      <aside className={`fixed left-0 top-0 h-screen w-64 bg-user-900 text-white flex flex-col z-50 transition-transform duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
        <div className="px-6 py-6 border-b border-user-800 flex justify-between items-center">
