...
import { HiOutlineUser, HiOutlineBell, HiOutlineCheckCircle, HiOutlineInformationCircle } from 'react-icons/hi';
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex-1 ml-64">
        <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-slate-200 px-8 py-4 flex items-center justify-end gap-4 relative">
